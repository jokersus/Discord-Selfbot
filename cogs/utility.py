...
class Utility:
    ...
    async def herokuupdate(self, ctx):
        ...
        async with self.session.get('https://api.github.com/repos/appu1232/Discord-Selfbot/git/refs/heads/master', headers={"Authorization": f"Bearer {git.githubtoken}"}) as resp:
